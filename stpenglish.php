  ...
  <nav class="z-depth-0 grey darken-1">
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li class="logged-out" style="display: none;">
          <a href="stpenglish.php" class="grey-text modal-trigger" data-target="modal-home">English</a>
        </li>

        <li class="logged-out" style="display: none;">
          <a href="stp.php" class="grey-text modal-trigger" data-target="modal-home">Español</a>
        </li>
   ...
   <ul class="sidenav" id="mobile-demo">
    ...
    <li><a href="stpenglish.php">English</a></li>
    <li><a href="stp.php">Español</a></li>
