...
<head>
  ...
  <title>True Color Cartriges STP T</title>
  ...
  <nav class="z-depth-0 grey darken-1">
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li class="logged-out" style="display: none;">
          <a href="stpenglish.html" class="grey-text modal-trigger" data-target="modal-home">English</a>
        </li>

        <li class="logged-out" style="display: none;">
          <a href="stp.html" class="grey-text modal-trigger" data-target="modal-home">Español</a>
        </li>
   ...
   <ul class="sidenav" id="mobile-demo">
    ...
    <li><a href="stpenglish.html">English</a></li>
    <li><a href="stp.html">Español</a></li>
  ...
  <section class="container section logged-out" style="display: none;" id="photo's">
    ...
    <div class="row">
      <div class="col s12 l4 ">
        <img src="./Spark_images/TrueColor+ Cartriges-STP-T/a4a3ef68-b004-4a08-99e4-3101f26e2fa9-1.jpg" alt="" class="responsive-img materialboxed">
      </div>
      <div class="col s12 l6 offset-l1">
        <h2 class="grey-text text-darken-4">True Color Cartriges SPD</h2>
...
<section class="container section logged-out" style="display: none;" id="photo's">
    ...
    <!-- closing div row -->
       ...
       <div class="row">
            ...
            <!-- Curved Magnum -->
            <!-- ////////////////////////////////////////////////////////////////////////////////////// -->
            <div class="col s12 m4">Curved Magnum
                <img src="./Spark_images/TrueColor Membrane Cartriges-SPD/10.jpg" alt="" class="responsive-img materialboxed">
